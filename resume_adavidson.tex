...
\begin{tabularx}{\textwidth}{@{}p{\dateColumnWidth}X@{}}
     & \textbf{Languages \& Tools}: Amazon Web Services, Claude Code, CSS, Docker, Git, Java, \LaTeX, Linux, Neo4j, React, Spring, SQL, TypeScript \\
...
\bigbreak
\begin{tabularx}{\textwidth}{@{}p{\dateColumnWidth}X@{}}
    Feb 2024 -- Aug 2024 & \textbf{Software Engineer (SkillBridge Intern)}                                                                                                 \\
