...
\setlength{\dateColumnWidth}{0.18\textwidth}
...
\begin{enumerate}[label={}, itemsep=5pt]
    \item \textbf{Languages}: CSS, Kotlin, Java, \LaTeX, TypeScript
    \item \textbf{Software \& Tools}: Amazon Web Services, Azure Kubernetes Services, Claude Code, Docker, Expo Application Services, Git, Jina Reader, LangChain, Linux, MySQL, Neo4j, OpenAI GPT, PostgreSQL, Prisma, React, React Native, Spring Framework
    \item \textbf{Practices}: Agile Software Development, Continuous Integration/Continuous Delivery, Extreme Programming, Test-Driven Development, User-Centered Design
...
\begin{tabularx}{\textwidth}{@{}p{\dateColumnWidth}X@{}}
    Aug 2024 -- Current & \textbf{Senior Software Engineer}                                                                                     \\
    & \textbf{Rise8} \textbar{} Remote                                                                                                                 \\
    & \detail Developed Risk Management Framework platform for simplifying and streamlining the continuous authority to operate (cATO) process. \\
    & \detail Leveraged Claude Code to recover failing deployment environments and codify configurations in Terraform                           \\
\end{tabularx}
\bigbreak
\begin{tabularx}{\textwidth}{@{}p{\dateColumnWidth}X@{}}
    Feb 2024 -- Aug 2024 & \textbf{SkillBridge Internship: Software Engineer}                                                                                              \\
...
\bigbreak
\begin{tabularx}{\textwidth}{@{}p{\dateColumnWidth}X@{}}
    Nov 2025 & \textbf{Certified Kubernetes Administrator} \textbar{} Cert ID: LF-t15c50ihdl        \\
\end{tabularx}
\bigbreak
\begin{tabularx}{\textwidth}{@{}p{\dateColumnWidth}X@{}}
