...
\begin{enumerate}[label={}, leftmargin=0pt, parsep=5pt]
    \item {\Large \textbf{PROFESSIONAL SUMMARY}}\xhrulefill{black!60}{3pt}
...
\begin{center}
\begin{enumerate}[label={}, leftmargin=0pt, parsep=5pt]
    \item {\Large \textbf{SKILLS}}\xhrulefill{black!60}{3pt}
    \begin{enumerate}[label={}, itemsep=5pt]
...
\begin{center}
\begin{enumerate}[label={}, leftmargin=0pt, parsep=5pt]
    \item {\Large \textbf{WORK HISTORY}}\xhrulefill{black!60}{3pt}
    \begin{enumerate}[label={}, itemsep=5pt]
...
\begin{center}
\begin{enumerate}[label={}, leftmargin=0pt, parsep=5pt]
    \item {\Large \textbf{EDUCATION}}\xhrulefill{black!60}{3pt}
    \begin{enumerate}[label={}, itemsep=5pt]
...
\begin{center}
\begin{enumerate}[label={}, leftmargin=0pt, parsep=5pt]
    \item {\Large \textbf{PROJECTS}}\xhrulefill{black!60}{3pt}
    \begin{enumerate}[label={}, itemsep=5pt]
...
\begin{enumerate}[label={}, leftmargin=0pt]
   \item {\Large \textbf{COMMENDATIONS}}\xhrulefill{black!60}{3pt}
   \begin{enumerate}[label={}]
